...
public class Dashboards extends javax.swing.JFrame {
    ...
    public static int incrimentRuns = 0;
    ...
    public String batingTeamA=tosss.GetBattingTeam();
    public String bowlingTeamB=tosss.GetBowlingTeam();
    public String batingTeamPath;
    public String bowlingingTeamPath;
    //public static int overTarget=totalOver;
    ...
    private void initComponents() {
        ...
        selectOver = new javax.swing.JComboBox<>();

        setDefaultCloseOperation(javax.swing.WindowConstants.EXIT_ON_CLOSE);
        setTitle("First Innings Dashboard");
        ...
        btbSave.setText("Second Innings Dashboard");
        ...
        selectOver.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Select Over", "1", "2", "5", "10" }));
        selectOver.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                selectOverActionPerformed(evt);
            }
        });
                            ...
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                ...
                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    .addGroup(jPanel1Layout.createSequentialGroup()
                                        ...
                                        .addGap(43, 43, 43)
                                        .addComponent(selectOver, javax.swing.GroupLayout.PREFERRED_SIZE, 142, javax.swing.GroupLayout.PREFERRED_SIZE))
                                    .addGroup(jPanel1Layout.createSequentialGroup()
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    ...
                    .addComponent(selectOver, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(119, 119, 119)
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                        ...
                        .addComponent(jPanel2, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(37, 37, 37)))
                .addComponent(btbSave, javax.swing.GroupLayout.PREFERRED_SIZE, 43, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(143, 143, 143))
        );
    ...
    public void bowlingTeamPath(){
        if(bowlingTeamB=="Bangladesh"){
            bowlingingTeamPath="C:\\Users\\DELL\\Desktop\\27954\\Dashboard\\src\\Files\\BowlingTeams\\BangladeshiBowlers.txt";
        }
        else if(bowlingTeamB=="England"){
            bowlingingTeamPath="C:\\Users\\DELL\\Desktop\\27954\\Dashboard\\src\\Files\\BowlingTeams\\EnglandBowlers.txt";
        }
        else if(bowlingTeamB=="Australia"){
            bowlingingTeamPath="C:\\Users\\DELL\\Desktop\\27954\\Dashboard\\src\\Files\\BowlingTeams\\AustralianBowlers.txt";
        }
        else if(bowlingTeamB=="India"){
            bowlingingTeamPath="C:\\Users\\DELL\\Desktop\\27954\\Dashboard\\src\\Files\\BowlingTeams\\IndianBowlers.txt";
        }
        else if(bowlingTeamB=="Sri Lanka"){
            bowlingingTeamPath="C:\\Users\\DELL\\Desktop\\27954\\Dashboard\\src\\Files\\BowlingTeams\\SriLankanBowlers.txt";
        }
        else{
    ...
    public void shoBowlersDate(){
        File file = new File(bowlingingTeamPath);
    ...
    private void btn1RunActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn1RunActionPerformed
                ...
                if(totalOver==individualover){
                    JOptionPane.showMessageDialog(null, "All Over", "ERROR !!!", JOptionPane.WARNING_MESSAGE);
            ...
            DefaultTableModel model3 = (DefaultTableModel) jTable1.getModel();
                ...
                // String totalball;
        //totalball=String.format("%d",totalBall );
        //txtEstimatedRun.setText(totalball);
    ...
    private void btbSaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btbSaveActionPerformed
        ...
        File file;
        file = new File("C:\\Users\\DELL\\Desktop\\27954\\Dashboard\\src\\"+fileName+"BatsmanSave.txt");
        try {
       ...
       // Date date = new Date();
        ...
        File file2;
        file2 = new File("C:\\Users\\DELL\\Desktop\\27954\\Dashboard\\src\\"+fileName+"BowlerSAve.txt");
        try {
            ...
            for(int i = 0; i < jTable2.getRowCount(); i++){//rows
                for(int j = 0; j < jTable2.getColumnCount(); j++){//columns
                    bw2.write(jTable2.getValueAt(i, j).toString()+" ");
                }
                bw2.newLine();
            }
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Dashboards2().setVisible(true);
            }
        });
    ...
    private void selectOverActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_selectOverActionPerformed
        // TODO add your handling code here:
        
        
        if(selectOver.getSelectedItem().equals("1")){
            
            totalOver = 1;
        }
        else if(selectOver.getSelectedItem().equals("2")){
            
            totalOver = 2;
        }
        else if(selectOver.getSelectedItem().equals("5")){
            
            totalOver = 5;
        }
        else if(selectOver.getSelectedItem().equals("10")){
            
            totalOver = 10;
        }
        else{
            JOptionPane.showMessageDialog(null, "Select a Over", "ERROR !!!", JOptionPane.ERROR_MESSAGE);

        }
        
        
    }//GEN-LAST:event_selectOverActionPerformed

    public int GetTarget(){
        
        return incrimentRuns + 1;
    }
    ...
    private javax.swing.JComboBox<String> selectOver;
